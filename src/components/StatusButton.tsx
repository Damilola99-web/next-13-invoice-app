...
export default function StatusButton({ status }: { status: 'paid' | 'pending' | 'draft' }) {
	if (status === 'paid') {
		return (
			<button
				...
				className='flex space-x-3 justify-center items-center text-center text-greeen w-[110px] h-[43px] px-5 py-2 rounded-md'
			>
	...
	if (status === 'pending') {
		return (
			<button
				...
				className='flex space-x-3 justify-center items-center text-center text-orange w-[110px] h-[43px] px-5 py-2 rounded-md'
			>
	...
	if (status === 'draft') {
		return (
			<button className='flex space-x-3 justify-center items-center text-center text-grey w-[110px] h-[43px] px-5 py-2 rounded-md dark:bg-grey/10 bg-dark-purple/10'>
		...
		return (
			<button
				...
				className='flex space-x-3 justify-center items-center text-center text-grey w-[110px] h-[43px] px-5 py-2 rounded-md'
			>
